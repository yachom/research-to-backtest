...
| A3 | (신설) | 시장 데이터 | pykrx로 수정주가 OHLCV·투자자 수급·KOSPI 수집, KRX 거래일 캘린더 — 🟡 구현 완료·가격 수집 완료 (2026-07-14). 수급·지수·캘린더 실수집은 KRX 무료 계정(KRX_ID/KRX_PW) 설정 후 `collect-market` 재실행으로 완료 (D1 개정 참고) |
